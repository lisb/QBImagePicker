...
- (instancetype)init
{
    ...
    if (self) {
        ...
        NSString *bundlePath = [self.assetBundle pathForResource:@"QBImagePicker_QBImagePickerController" ofType:@"bundle"];
        if (bundlePath == nil) {
            bundlePath = [self.assetBundle pathForResource:@"QBImagePicker" ofType:@"bundle"];
        }
        if (bundlePath) {
